...
class ScannerDetector
{
    ...
    protected array $scanners = [
        ...
        // Not a bare 'zap' — that substring also lives in legitimate agents
        // like Zapier's webhook client.
        'owasp zap' => ['name' => 'OWASP ZAP', 'severity' => 'error'],
        'zaproxy' => ['name' => 'OWASP ZAP', 'severity' => 'error'],
        ...
        'feroxbuster' => ['name' => 'FeroxBuster', 'severity' => 'error'],
        'ffuf' => ['name' => 'FFUF', 'severity' => 'error'],
        'wfuzz' => ['name' => 'Wfuzz', 'severity' => 'error'],
        'arachni' => ['name' => 'Arachni', 'severity' => 'critical'],
        'wapiti' => ['name' => 'Wapiti', 'severity' => 'critical'],
        'skipfish' => ['name' => 'Skipfish', 'severity' => 'critical'],
        'commix' => ['name' => 'Commix', 'severity' => 'critical'],
        'jaeles' => ['name' => 'Jaeles', 'severity' => 'critical'],
        'dalfox' => ['name' => 'Dalfox', 'severity' => 'error'],
        'xsstrike' => ['name' => 'XSStrike', 'severity' => 'error'],
        'joomscan' => ['name' => 'JoomScan', 'severity' => 'error'],
        'droopescan' => ['name' => 'DroopeScan', 'severity' => 'error'],
        'whatweb' => ['name' => 'WhatWeb', 'severity' => 'warning'],
        'qualys' => ['name' => 'Qualys', 'severity' => 'warning'],
